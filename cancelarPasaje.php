...
$mail->SMTPAuth = true;
$mail->Port = 2525;
$mail->Username = 'e3ef2673945c5a';
$mail->Password = '5a6b13291764a3';
   ...
   $link = conectar();
    ...
    $pagina= $_POST['pagina'];
    $consulta0="SELECT fecha_hora_salida, fecha_hora_llegada, id_ruta, precio, cupo,total FROM viajes inner join clientes_viajes on (viajes.id_viaje=clientes_viajes.id_viaje)WHERE (viajes.id_viaje= '$id_viaje_original') and (clientes_viajes.id_cliente='$id') and (clientes_viajes.estado='pendiente')";
