...
//    echo "<script > alert('inicio funcion exitosamente');window.location='llamarCancelarViaje.php'</script>";
    include "BD.php";// conectar y seleccionar la base de datos
  //    echo "<script > alert('sgo funcion exitosamente');window.location='llamarCancelarViaje.php'</script>";
    $link = conectar();
